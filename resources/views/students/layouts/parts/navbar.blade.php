<nav class="navbar navbar-expand-lg main-navbar bg-linear">
  <a href="index.html" class="navbar-brand sidebar-gone-hide">
    {{-- <img src="https://www.mksofttech.com/wp-content/uploads/2017/11/laravel-logo.png" alt=""  width="40px"> --}}
    ELearning</a>
  ...
  <ul class="navbar-nav navbar-right">
    ...
    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
      <img alt="image" src="https://lh3.googleusercontent.com/a-/AAuE7mC5BON-3hNhNBfBouUiodlz6aTJOU9n8KI8iD06QQ=s40-c" class="rounded-circle mr-1">
      <div class="d-sm-none d-lg-inline-block">Suryo Widiyanto</div></a>
