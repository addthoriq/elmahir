            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('course.create')}}" class="btn mb-1 btn-rounded btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
                        <a href="#" class="btn mb-1 btn-rounded btn-success btn-sm text-white"><i class="fas fa-download"></i> Ekspor</a>
                        <a href="{{ route('course.nonactived') }}" class="btn mb-1 btn-rounded btn-dark btn-sm"><i class="fa fa-window-close"></i> Daftar Nonaktif</a>
