    ...
    <div class="row page-titles mx-0">
        <div class="col p-md-0">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{route('course.nonactived')}}">Daftar Pengajar & Mata Pelajaran nonaktif</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Daftar Pengajar & Mata Pelajaran nonaktif</h4>
                        <a href="{{route('course.index')}}" class="btn mb-1 btn-rounded btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
