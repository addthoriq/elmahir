    ...
    <div class="modal-content">
            <div class="modal-header py-2">
                ...
                <div class="d-flex justify-content-start pl-2 align-items-start flex-column">
                    <h4 class="modal-title text-align-left">Tambah File Tugas</h4>
                    {{-- <h5>{{ $section->title }}</h5> --}}
                </div>
            </div>
            <div class="modal-body">
                <form id="form" action="{{ route('task.addFile', $task->id) }}" class="wizard-big" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row boxs">
                        <div class="col-md-12">
