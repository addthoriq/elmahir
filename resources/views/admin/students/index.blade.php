                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('student.create')}}" class="btn mb-4 btn-rounded btn-primary btn-sm"><i class="fa fa-plus"></i> Tambah</a>
                            <a href="#" class="btn mb-4 btn-rounded btn-success btn-sm text-white"><i class="fas fa-download"></i> Ekspor</a>
                            <a href="{{route('alumni.index')}}" class="btn mb-4 btn-rounded btn-sm btn-secondary text-white"><i class="fa fa-graduation-cap"></i> Alumni</a>
