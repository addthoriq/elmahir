...
<head>
    ...
    <title>Elearning | Your Page is Under Construction</title>
    <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Under Construction</h4>
                                <p>Your Request page is under Construction for a while.</p>
                                <form class="mt-5 mb-5">

                                    <div class="text-center mb-4 mt-4"><a href="{{route('home.index')}}" class="btn btn-primary">Go to Homepage</a>
                                    </div>
                                </form>
