        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="{{route('alumni.index')}}">Daftar Alumni</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('student.index')}}" class="btn mb-1 btn-rounded btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Kembali</a>
