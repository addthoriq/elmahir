...
<head>
    ...
    <title>Elearning | Halaman tidak diizinkan</title>
    <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Halaman tidak diizinkan</h4>
                                <p>Anda tidak mempunyai izin untuk mengakses Halaman ini</p>
                                <form class="mt-5 mb-5">
                                    <div class="text-center mb-4 mt-4"><a href="{{route('home.index')}}" class="btn btn-primary">Kembali ke Beranda</a>
                                    </div>
                                </form>
                                <div class="text-center">
                                    <p>Copyright © by <a href="https://pondokinformatika.com">Pondok Informatika Al Madinah</a>, 2019</p>
                                </div>
                            </div>
                        </div>
                    </div>
