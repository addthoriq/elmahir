...
<head>
    ...
    <title>Elearning | Halaman dalam Perbaikan</title>
    <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Halaman Dalam Perbaikan</h4>
                                <p>Mohon Maaf, Halaman yang anda minta dalam perbaikan</p>
