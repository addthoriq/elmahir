...
<head>
    ...
    <title>Elearning | Halaman tidak ditemukan</title>
    <!-- Favicon icon -->
                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> Halaman tidak ditemukan</h4>
                                <p>Mohon Maaf, Halaman yang anda minta tidak ditemukan</p>
