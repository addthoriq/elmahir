                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label>NISN</label>
                                <input type="text" value="{{$data->nip}}" name="nip" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>NIK</label>
                                <input type="text" value="{{isset($data->profileTeacher->nik)?$data->profileTeacher->nik:''}}" name="nik" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nama</label>
