                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select id="name" class="form-control m-b" name="name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="teacher_id" type="text" name="teacher_id" value="{{$history->teacher->name}}" autocomplete="off" data-provide="typeahead" class="typeahead form-control" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="classroom_id[]" id="classroom_id">
                                            <option value="{{$history->classroom_id}}">-- {{$history->classroom->name}} --</option>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="assistant" name="assistant" type="text" value="{{($history->assistant)?$history->assistant:''}}" class="form-control">
