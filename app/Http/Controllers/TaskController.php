...
{
    protected $folder     = 'pages.tasks';
    protected $rdr        = '/task';

    public function index()
    {
        $ajax     = route('task.dbtb');
        return view('pages.tasks.index', compact('ajax'));
    }
    ...
    {
        $courses   = Course::all();
        return view('pages.tasks.create', compact('courses'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.tasks.show', compact('task', 'fileTask'));
    }
